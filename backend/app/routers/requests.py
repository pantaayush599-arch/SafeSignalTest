...
def get_request(request_id: str, db: Session = Depends(get_db), identity=Depends(get_current_identity)):
    ...
    return RequestStateOut(
        ...
        channel=req.channel,
        caller_phone_number=req.caller_phone_number,
        known_contact_checked=req.known_contact_checked,
        known_contact_match=req.known_contact_match,
        known_contact_name=req.known_contact_name,
        reported_scam_number=req.reported_scam_number,
        scam_report_count=req.scam_report_count,
